...
import com.app.Service.ShipService;
...
/**
 * The @SpringBootApplication annotation enables automatic configuration of a Spring application.
 *
 * Refer to ContainerService for functional transactional logic, and to ShipService for the implementation 
 * changes required to enable rollback behavior.
 */
...
public class Application {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		// Allow Spring context to fully initialize before producing output
		Thread.sleep(500);
